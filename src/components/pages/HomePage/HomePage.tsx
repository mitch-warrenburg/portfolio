...
const headerTabs: Array<Tab<HeaderTabId>> = [
  {
    id: 'home',
    content: 'Home',
  },
...
const techMenuItems: Array<MenuItem<TechMenuItemId>> = [
  {
    id: 'react',
    content: (
      <>
...
const HomePage: FC = () => {
  ...
  const [selectedTechId, setSelectedTechId] = useState<TechMenuItemId | undefined>();
  ...
  const menuItemClickHandler: MouseEventHandler<HTMLLIElement> = useCallback(event => {
    const { id } = event.target as HTMLLIElement;
    setSelectedTechId(id as TechMenuItemId);
  }, []);
      ...
      <Panel>
        ...
        <div className="content-panel__nav-left-container">
          <div className="content-panel__nav-left">
            <Menu label="Skills" items={techMenuItems} onClickItem={menuItemClickHandler} />
          </div>
